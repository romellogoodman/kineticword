...
function ExportButton({ duration, isExporting, onExport }) {
  return (
    <button onClick={onExport} disabled={isExporting} className={isExporting ? 'exporting' : ''}>
...
function Controls({
  ...
  return (
    <div className="controls">
      ...
      <div className="control-group">
        <ExportButton duration={duration} isExporting={isExporting} onExport={onExport} />
      </div>
    </div>
  );
}
    ...
    try {
      ...
      try {
        ...
        if (!fallbackResponse.ok) {
          throw new Error(
            `Failed to load fallback font: ${fallbackResponse.status} ${fallbackResponse.statusText}`
          );
        }
      ...
      <div className="main-content">
        <div className="animation-container" ref={containerRef}>
          <div className="hidden-overflow">
            <p ref={slideRef} className="truculenta slide">
              {text}
            </p>
          </div>
        </div>
